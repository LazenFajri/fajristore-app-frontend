    ...
    <section>
      <div class="max-w-screen-2xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
        <header class="text-center">
          ...
          Jelajahi produk terbaru kami dan tingkatkan gaya Anda dengan koleksi eksklusif baru kami.
          </p>
              ...
              <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8">
                <div className="max-w-md mx-auto text-center lg:text-left">
                  <header>
                    ...
                    <p className="mt-1 text-lg text-primary">Rp. {formatPrice(product.price)}</p>
                  </header>
