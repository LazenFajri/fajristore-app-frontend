...
export default function Cart() {
  ...
  function deleteCart(id) {
    clearCart();
    toast.success('Keranjang Terhapus!')
  }
        ...
        <div className=" md:w-2/3  px-4">
          <div className=" mt-16 md:mt-6 ">
            <header className="text-center flex justify-between w-full">
              <h1 className="text-xl font-bold text-gray-900 sm:text-3xl">Keranjang Anda</h1>
            </header>
            {loading ? (
              ...
              !products?.length ? (
                <p className="my-6 text-center ">keranjang Anda kosong</p>
              ) : (
                <>
                        ...
                        <li className="flex items-center gap-4 justify-between">
                          ...
                          <div>
                            ...
                            <dl className="mt-0.5 space-y-px text-[10px] text-text">
                              <p>Rp .{cartProducts.filter(id => id === product._id).length * product.price}</p>
                            </dl>
                          </div>
                    ...
                    <div className=" max-w-md space-y-4">
                      <dl className="space-y-0.5 text-md text-gray-700">
                        <div className="flex justify-end text-red-400 border-b mb-3">
                          <button onClick={deleteCart}>Hapus Keranjang</button>
                        ...
                        <strike className="flex justify-between">
                          <dt>VAT</dt>
                          <dd>Rp. {formatPrice(total / 1000)}</dd>
                        </strike>
        ...
        {!products.length ? (
          ...
          <div className="md:1/3 mt-16 md:mt-6">
            <header className="text-start flex flex-col w-full">
              <h1 className="text-xl font-bold text-gray-900 sm:text-3xl">Rincian pengiriman</h1>
              <p className="mt-2 text-text text-lg">Kami menggunakan detail akun Anda untuk pengiriman.</p>
            </header>
  ...
  return <>
    <div className="grid h-screen px-4 bg-white place-content-center">
      <div className="text-center">
        ...
        <p className="mt-4 text-text text-2xl">Anda harus Login untuk melihat Item keranjang</p>
